...
export const BriefcaseIcon: React.FC<IconProps> = ({ className = "w-5 h-5 text-accent" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.92a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.92-1.75l.22-.16a2.25 2.25 0 00-1.1-4.48l-.15-.04A2.25 2.25 0 013 5.25V4.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 4.5v.75a2.25 2.25 0 01-1.33 2.08l-.15.04a2.25 2.25 0 00-1.1 4.48l.22.16a2.25 2.25 0 01.92 1.75z" />
  </svg>
);

export const AcademicCapIcon: React.FC<IconProps> = ({ className = "w-5 h-5 text-accent" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0112 20.055a11.952 11.952 0 01-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222 4 2.222V20M1 12v7a2 2 0 002 2h18a2 2 0 002-2v-7" />
    </svg>
);
...
export const SunIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.263l-1.591 1.591M3 12h2.25m1.386-9.182l-1.591-1.591M12 18.75V21m0-16.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9z" />
